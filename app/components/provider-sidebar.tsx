...
const navItems = [
  { href: "/provider", icon: Home, label: "الرئيسية" },
  { href: "/provider/services", icon: Briefcase, label: "خدماتي" },
  { href: "/provider/leads", icon: Users, label: "الطلبات" },
  { href: "/provider/profile", icon: Settings, label: "الملف الشخصي" },
];
